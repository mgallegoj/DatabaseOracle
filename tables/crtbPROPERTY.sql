...
CONSTRAINT PK_PROPTY PRIMARY KEY(ID_PROPERTY),
CONSTRAINT CK_PROPTY_STRATUM_01 CHECK (STRATUM >= 1 AND STRATUM <= 6),
CONSTRAINT CK_PROPTY_TAX_02 CHECK (TAX > 1 AND TAX <= 1000000000),
CONSTRAINT CK_PROPTY_PROPERTY_TYPE_03 CHECK (PROPERTY_TYPE IN ('Residencial', 'No residencial')),
CONSTRAINT CK_PROPTY_CITY_ADDRESS_04 UNIQUE (CITY, ADDRESS),
...
COMMENT ON COLUMN APP_PAGO_PREDIAL.PGP_PROPERTY.ID_PROPERTY IS 'Id autogenerated of the property';
