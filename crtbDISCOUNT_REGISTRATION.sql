...
ID_POPERTY						INTEGER 		UNIQUE NOT NULL,
...
CONSTRAINT CK_DISREG_NETPAYMENT_01 CHECK (NET_PAYMENT > 1 AND NET_PAYMENT <= 5000000),
CONSTRAINT FK_DISREG_PROPTY_01 FOREIGN KEY(ID_POPERTY) REFERENCES APP_PAGO_PREDIAL.PGP_PROPERTY(ID_POPERTY),
...
COMMENT ON COLUMN APP_PAGO_PREDIAL.PGP_DISCOUNT_REGISTRATION.NET_PAYMENT IS 'Amount to pay for the new tax max value is 9,999,999.99';
...
COMMENT ON COLUMN APP_PAGO_PREDIAL.PGP_DISCOUNT_REGISTRATION.ID_POPERTY IS 'Id of the property';
